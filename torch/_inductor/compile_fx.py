...
class _InductorFakeTensorProp(FakeTensorProp):
    def __init__(
        self, module: torch.fx.GraphModule, mode: torch._subclasses.FakeTensorMode
    ) -> None:
        super().__init__(module, mode=mode)
...
def fake_tensor_prop(
    ...
    """
    # This full pass refreshes metadata after graph-wide rewrites such as
    # view_to_reshape. FakeTensorUpdater handles later local graph edits.
