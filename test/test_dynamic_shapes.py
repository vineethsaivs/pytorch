...
def forward(self, arg0_1: "i64[2][1]cpu", arg1_1: "Sym(u2)", arg2_1: "Sym(u3)", arg3_1: "f32[u2, u3][1, u2]cpu"):
    ...
    def test_unbacked_contiguous(self):
        ...
        add_3: "f32[u0, u1][Max(1, u1), 1]cpu" = torch.ops.aten.add.Scalar(clone, 1);  clone = None
        mul_6: "f32[u0, u1][Max(1, u1), 1]cpu" = torch.ops.aten.mul.Scalar(add_3, 100);  add_3 = None
        return (mul_6,)""",
            ignore_comments=True,
            ignore_empty_lines=True,
        )
        ...
        ge_1: "Sym(u1 >= 0)" = arg1_1 >= 0;  arg1_1 = None
        _assert_scalar_1 = torch.ops.aten._assert_scalar.default(ge_1, "Runtime assertion failed for expression u1 >= 0 on node 'ge_1'");  ge_1 = _assert_scalar_1 = None
        add: "f32[u0, u1][Max(1, u1), 1]cpu" = torch.ops.aten.add.Scalar(arg2_1, 1);  arg2_1 = None
        mul_5: "f32[u0, u1][Max(1, u1), 1]cpu" = torch.ops.aten.mul.Scalar(add, 100);  add = None
        return (mul_5,)""",
            ignore_comments=True,
            ignore_empty_lines=True,
        )
